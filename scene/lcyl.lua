...
rotPoint:translate(0, 1, 0)

rotSphere = rt.sphere('rotSphere')
rotSphere:scale(0.3, 0.3, 0.3)
rotSphere:set_material(brown)

cyl2 = rt.cylinder('c')
cyl2:scale(0.25/0.3, 2/0.3, 0.25/0.3)
cyl2:rotate('z', 30)
cyl2:set_material(brown)

cyl3 = rt.cylinder('c')
cyl3:scale(0.20/0.3, 2.0/0.3, 0.20/0.3)
cyl3:rotate('z', -20)
cyl3:set_material(brown)

cyl4 = rt.cylinder('c')
cyl4:scale(0.20/0.3, 2.0/0.3, 0.20/0.3)
cyl4:rotate('x', -25)
cyl4:set_material(brown)

rotSphere:add_child(cyl2)
